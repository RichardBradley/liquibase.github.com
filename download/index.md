...
## Current Liquibase Core Release: 3.5.2 (Sept 21, 2016) ##
...
<td style="width:75%; text-align: right; padding-right: 30px" colspan="2">
    <a href="https://github.com/liquibase/liquibase/releases/download/liquibase-parent-3.5.2/liquibase-3.5.2-bin.zip" style="font-weight: bold; font-size: larger" onclick="trackOutboundLink(this, 'Download 3.5.2', 'github.com'); return false;">Download liquibase-3.5.2-bin.zip</a><br>
    <a href="https://github.com/liquibase/liquibase/releases/download/liquibase-parent-3.5.2/liquibase-3.5.2-bin.tar.gz" style="font-weight: bold; font-size: larger" onclick="trackOutboundLink(this, 'Download 3.5.2', 'github.com'); return false;">Download liquibase-3.5.2-bin.tar.gz</a></td>
