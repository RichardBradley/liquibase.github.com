...
The current stable version of Liquibase Core is 3.0.1 (Released June 25, 2013).
<ul>
<li><a href="http://sourceforge.net/projects/liquibase/files/Liquibase%20Core/liquibase-3.0.1-bin.zip/download" onclick="trackOutboundLink(this, 'Download 3.0.1', 'sourceforge.net'); return false;">liquibase-3.0.1-bin.zip</a></li>
<li><a href="http://sourceforge.net/projects/liquibase/files/Liquibase%20Core/liquibase-3.0.1-bin.tar.gz/download" onclick="trackOutboundLink(this, 'Download 3.0.1', 'sourceforge.net'); return false;">liquibase-3.0.1-bin.tar.gz</a></li>
</ul>
